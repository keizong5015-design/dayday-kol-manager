        ...
        <div style={{ position: 'relative', paddingTop: '80%', background: '#F3F4F6' }}>
          {inf.photo_url ? (
            ...
            <div style={{
              ...
              fontSize: '52px', background: 'linear-gradient(135deg, #FFF0EE, #FFE4E1)',
            }}>
              👤
            </div>
          )}
          ...
          {platforms.length > 0 && (
            <div style={{ position: 'absolute', bottom: 10, right: 10, display: 'flex', gap: '4px' }}>
              {platforms.map(p => (
                <span key={p} style={{
                  background: PLATFORM_COLOR[p] || '#6B7280',
        ...
        <div style={{ padding: '14px' }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '14px', fontWeight: 800, color: '#E8523A' }}>
            ...
            <div style={{ position: 'relative', paddingTop: '45%', background: '#F3F4F6' }}>
              {inf.photo_url ? (
                ...
                <div style={{
                  position: 'absolute', inset: 0,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: '64px', background: 'linear-gradient(135deg, #FFF0EE, #FFE4E1)',
                }}>👤</div>
              )}
              <button
                onClick={() => setShowDetail(false)}
